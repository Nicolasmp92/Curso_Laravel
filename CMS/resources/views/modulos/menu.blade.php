{{-- TODO Esto es el sidebar --}}
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="circular CMS logo with white letters on a blue background, logo appears slightly raised, conveys a professional and modern tone" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{route ('front.view')}}" class="nav-link">
